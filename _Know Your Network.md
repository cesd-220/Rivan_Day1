...
Task:
 1. CoreTAAS must have the following SVIs
   ...
   - VLAN 50
     - IP address: 10.91.50.2
     - Description: CCTV-VLAN
     - Status: UP

   - VLAN 100
     - IP address: 10.91.100.2
...
!@CoreBABA
conf t
 ip dhcp excluded-address 10.91.1.1 10.91.1.100
 ip dhcp excluded-address 10.91.10.1 10.91.10.100
 ip dhcp excluded-address 10.91.50.1 10.91.50.100
...
!@CoreBABA
conf t
 ip dhcp excluded-address 10.91.100.1 10.91.100.100
...
conf t
 ...
 ip dhcp pool CAMERA6
  host 10.91.50.6 255.255.255.0
  client-identifier #camera6macadd#
 ip dhcp pool CAMERA8
  host 10.91.50.8 255.255.255.0
...
conf t
 ...
 telephony-service
  ...
  max-ephones 5
  max-dn 20
  ip source-address 10.91.100.8 port 2000
  end
~~~

<br>

*Why 10.91.100.8? __TFTP__*
...
conf t
 ...
 ip route 10.91.0.0 255.255.0.0 10.91.91.4 254
 end
~~~
...
conf t
 ip routing
 ip route 0.0.0.0 0.0.0.0 10.91.100.4 254
 end
~~~
...
!@CoreBABA
conf t
 ip route 0.0.0.0 0.0.0.0 10.91.91.1 254
 end
~~~
...
~~~
!@cmd
ping 10.91.1.2                 CoreTAAS
ping 10.91.1.4                 CoreBABA
ping 10.91.100.8               CUCM
ping 10.91.91.1            EDGE
~~~
